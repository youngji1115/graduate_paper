...
.method constructor <init>(Landroid/content/Context;III)V
    ...
    iput-object v0, p0, Lcom/tnkfactory/ad/gq;->k:Landroid/graphics/Bitmap;

    invoke-virtual {p0, p4}, Lcom/tnkfactory/ad/gq;->setId(I)V

    invoke-direct {p0, p1, p2, p3}, Lcom/tnkfactory/ad/gq;->b(Landroid/content/Context;II)V

    return-void
.end method

.method public static a(Landroid/content/Context;II)Lcom/tnkfactory/ad/gq;
    .locals 3
    ...
    new-instance v1, Lcom/tnkfactory/ad/gq;

    const/16 v2, 0x63

    invoke-direct {v1, p0, p2, p1, v2}, Lcom/tnkfactory/ad/gq;-><init>(Landroid/content/Context;III)V

    invoke-virtual {v1, v0}, Lcom/tnkfactory/ad/gq;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance v0, Lcom/tnkfactory/ad/gr;

    invoke-direct {v0}, Lcom/tnkfactory/ad/gr;-><init>()V

    invoke-virtual {v1, v0}, Lcom/tnkfactory/ad/gq;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {v1, p1, p2}, Lcom/tnkfactory/ad/gq;->a(II)V
...
.method private b(Landroid/content/Context;II)V
    ...
    invoke-virtual {p0, v0}, Lcom/tnkfactory/ad/gq;->setBackgroundColor(I)V

    invoke-direct {p0, p3, p2}, Lcom/tnkfactory/ad/gq;->b(II)[I
    ...
    invoke-virtual {p0, v5}, Lcom/tnkfactory/ad/gq;->addView(Landroid/view/View;)V
    ...
    invoke-static {p1, v6, v8}, Lcom/tnkfactory/ad/fr;->a(Landroid/content/Context;Landroid/view/ViewGroup$LayoutParams;I)Landroid/widget/ImageView;
    ...
    invoke-static {p1, v5, v1}, Lcom/tnkfactory/ad/fr;->a(Landroid/content/Context;Landroid/view/ViewGroup$LayoutParams;I)Landroid/widget/ImageView;
    ...
    invoke-static {p1, v1, v2}, Lcom/tnkfactory/ad/fr;->d(Landroid/content/Context;Landroid/view/ViewGroup$LayoutParams;I)Landroid/widget/ImageButton;
    ...
    new-instance v2, Lcom/tnkfactory/ad/gs;

    invoke-direct {v2, p0}, Lcom/tnkfactory/ad/gs;-><init>(Lcom/tnkfactory/ad/gq;)V
    ...
    invoke-static {p1, v1, v0}, Lcom/tnkfactory/ad/fr;->b(Landroid/content/Context;Landroid/view/ViewGroup$LayoutParams;I)Landroid/widget/TextView;
...
.method protected a()V
    ...
    invoke-virtual {p0, v0}, Lcom/tnkfactory/ad/gq;->a(I)Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Lcom/tnkfactory/ad/gq;->k:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Lcom/tnkfactory/ad/gq;->k:Landroid/graphics/Bitmap;
...
.method public a(Landroid/graphics/Bitmap;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/tnkfactory/ad/gq;->k:Landroid/graphics/Bitmap;
