...
.method public constructor <init>(Lcom/amazonaws/retry/RetryPolicy$RetryCondition;Lcom/amazonaws/retry/RetryPolicy$BackoffStrategy;IZ)V
    .locals 2
    .param p1, "retryCondition"    # Lcom/amazonaws/retry/RetryPolicy$RetryCondition;
    .param p2, "backoffStrategy"    # Lcom/amazonaws/retry/RetryPolicy$BackoffStrategy;
    .param p3, "maxErrorRetry"    # I
    .param p4, "honorMaxErrorRetryInClientConfig"    # Z
